...
with st.expander('AF : 가사 : 키워드 = 0.8 : 0.1 : 0.1 인 경우'):
    ...
    with col1:
        ...
        st.image('도서목록/참을 수 없는 존재의 가벼움.png')
