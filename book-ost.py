...
with st.expander('AF : 가사 : 키워드 = 0.8 : 0.1 : 0.1 인 경우'):
    ...
    with col1:
        ...
        st.image(Image.open('도서목록/참을 수 없는 존재의 가벼움.png'))
    ...
    with col4:
        st.markdown('**4. 모순**')
        st.image(Image.open('도서목록/모순.png'))
    ...
    with col7:
        ...
        st.image(Image.open('도서목록/무의미의 축제.png'))
    ...
    with col8:
        ...
        st.image(Image.open('도서목록/80일간의 세계일주.png'))
    ...
    with col9:
        ...
        st.image(Image.open('도서목록/몬테크리스토 백작.png'))
    ...
    with col10:
        ...
        st.image(Image.open('도서목록/페드르와 이폴리트.png'))
    ...
    with col11:
        ...
        st.image(Image.open('도서목록/결혼 여름.png'))
...
with st.expander('가사 중심인 경우'):
    ...
    with col2:
        st.markdown('**2. 어린왕자**')
        st.image(Image.open('도서목록/어린왕자.png'))
    ...
    with col4:
        ...
        st.image(Image.open('도서목록/로미오와 줄리엣.png'))
    ...
    with col5:
        ...
        st.image(Image.open('도서목록/아주 편안한 죽음.png'))
    ...
    with col7:
        ...
        st.image(Image.open('도서목록/잘못 걸려온 전화.png'))
    ...
    with col8:
        st.markdown('**8. 파우스트**')
        st.image(Image.open('도서목록/파우스트.png'))
    ...
    with col9:
        ...
        st.image(Image.open('도서목록/어떻게든 이별.png'))
